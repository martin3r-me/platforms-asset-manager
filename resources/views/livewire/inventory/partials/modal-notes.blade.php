...
<x-ui-modal model="showNotes" size="md">
    ...
    <div>
        ...
        <textarea wire:model="nNotes" rows="6" class="w-full px-2 py-1.5 text-xs rounded-md bg-black/[0.02] dark:bg-white/[0.03] border border-black/10 dark:border-white/10 resize-none"></textarea>
    ...
    <x-slot name="footer">
        ...
        <x-ui-button variant="primary" size="sm" wire:click="saveNotes" wire:loading.attr="disabled">
