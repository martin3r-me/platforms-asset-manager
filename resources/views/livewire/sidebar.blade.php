<div>
    ...
    <x-ui-sidebar-list label="Einstellungen">
        ...
        <x-ui-sidebar-item :href="route('asset-manager.settings')" :active="request()->routeIs('asset-manager.settings')">
            @svg('heroicon-o-cog-6-tooth', 'w-4 h-4 text-[var(--ui-secondary)]')
            <span class="ml-2 text-sm">Modul-Einstellungen</span>
        </x-ui-sidebar-item>
    </x-ui-sidebar-list>
    ...
    <div x-show="collapsed" class="px-2 py-2 border-b border-[var(--ui-border)]">
        <div class="flex flex-col gap-2">
            ...
            <a href="{{ route('asset-manager.settings') }}" wire:navigate class="flex items-center justify-center p-2 rounded-md {{ request()->routeIs('asset-manager.settings') ? 'bg-[var(--ui-primary-10)] text-[var(--ui-primary)]' : 'text-[var(--ui-secondary)] hover:bg-[var(--ui-muted-5)]' }}">
