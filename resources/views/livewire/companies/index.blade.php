<div class="space-y-4">
    ...
    <h2 class="flex items-center gap-2 text-sm font-semibold uppercase tracking-wide text-[var(--ui-secondary)]">
        ...
        Gesellschaften
        <span class="text-xs font-normal normal-case text-gray-400">· {{ $companies->count() }}</span>
    </h2>
    ...
    <div class="rounded-xl bg-white/60 border border-black/5 shadow-sm overflow-hidden">
        <table class="w-full text-sm">
            <tbody class="divide-y divide-black/[0.03]">
                ...
                @empty
                    <tr><td class="px-4 py-6 text-center text-xs text-gray-400">Noch keine Gesellschaften angelegt.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
