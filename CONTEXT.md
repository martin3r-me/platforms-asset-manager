...
- **Zuordnung** (`AssetAssignment`) — Die Verknüpfung [[Gerät]]/Item ↔ Mitarbeiter über einen **Zeitraum** (von/bis); **Übergabe** = der Wechselvorgang. Bei Geräten aus dem MDM abgeleitet, bei Items/gepinnten Geräten manuell. _Avoid_: Besitz, Owner (Intune-Begriff).
